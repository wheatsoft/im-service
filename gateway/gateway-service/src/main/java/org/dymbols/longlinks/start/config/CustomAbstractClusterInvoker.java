 ...
 */
public abstract class CustomAbstractClusterInvoker<T> implements ClusterInvoker<T> {

    private static final Logger logger = LoggerFactory.getLogger(CustomAbstractClusterInvoker.class);
    ...
    public CustomAbstractClusterInvoker() {
    }

    public CustomAbstractClusterInvoker(Directory<T> directory) {
        this(directory, directory.getUrl());
    }

    public CustomAbstractClusterInvoker(Directory<T> directory, URL url) {
        if (directory == null) {
